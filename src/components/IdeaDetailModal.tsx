      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl">
        ...
        <DialogHeader className="mb-4">
          ...
          <DialogDescription className="sr-only">
            Detailed information about the startup idea
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <Button
            ...
            className="px-4 py-2.5 rounded-xl border border-red-200 bg-red-50 text-red-600 hover:bg-red-100 hover:border-red-300 text-sm font-medium"
            title="Delete idea"
          >
            <svg
              width="16"
        ...
        {showContact && !sent && (
          <div className="bg-linear-to-br from-indigo-50 to-purple-50 rounded-2xl p-5 border border-indigo-100">
            ...
            <Textarea
              ...
              placeholder={`Hi ${
                idea.founder.name.split(" ")[0]
              }, I saw your idea "${idea.title}" on Atlas and I'd love to chat about...`}
              rows={4}
              className="bg-white mb-3 border-indigo-200 focus-visible:border-indigo-400 focus-visible:ring-indigo-400/20"
            />
            <div className="flex gap-2">
              <Button
                ...
                className="px-4 py-2 rounded-xl text-sm text-gray-500 hover:bg-white"
              >
                Cancel
              </Button>
              <Button
                ...
                className="flex-1 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-300 text-white text-sm font-medium py-2 rounded-xl disabled:cursor-not-allowed"
              >
                Send message ✉️
              </Button>
            </div>
